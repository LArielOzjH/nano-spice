...
\begin{titlepage}
  ...
  \fduemblem[x=0.18pt, y=0.18pt]

  \vspace{2.2cm}

  % 标题：用字距拉开，去掉硬框，仅保留下方细线
  {\LARGE\bfseries\sffamily\ziju{0.15}共源 NMOS 放大器\par}
  \vspace{0.55cm}
  {\LARGE\bfseries\sffamily SPICE 仿真器设计报告\par}
  \vspace{0.9cm}
  ...
  \begin{tabular}{r@{\hspace{0.5em}}l}
    \textbf{小组成员：} & \uline{\hspace{0.5em}王耀冬\quad 陈星\quad 韩卓骏\hspace{0.5em}} \\
    \textbf{代码仓库：} & \uline{\hspace{0.5em}\url{https://github.com/LArielOzjH/nano-spice}\hspace{0.5em}} \\
    \textbf{仿真语言：} & \uline{\hspace{0.5em}Python 3 \ (NumPy + Matplotlib)\hspace{0.5em}} \\
  \end{tabular}
  \par}
