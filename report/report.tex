...
\begin{titlepage}
  ...
  % 主标题：仿宋，单行
  {\LARGE 共源 NMOS 放大器\;SPICE 仿真器设计报告\par}
  \vspace{0.9cm}
  \rule{0.55\linewidth}{0.4pt}

  \vspace{3.2cm}

  % 信息行：仿宋，标签加冒号 + 下划线值，字号放大
  {\large
  \renewcommand{\arraystretch}{2.0}
  \begin{tabular}{r@{\hspace{0.5em}}l}
    小组成员： & \uline{\hspace{0.5em}王耀冬\quad 陈星\quad 韩卓骏\hspace{0.5em}} \\
    代码仓库： & \uline{\hspace{0.5em}\url{https://github.com/LArielOzjH/nano-spice}\hspace{0.5em}} \\
    仿真语言： & \uline{\hspace{0.5em}Python 3 \ (NumPy + Matplotlib)\hspace{0.5em}} \\
  \end{tabular}
  \par}
