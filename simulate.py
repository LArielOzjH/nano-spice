...
# ═══════════════════════════════════════════════════════════════════════════
# AC Small-Signal Frequency Analysis (Level-3)
#
# Extends MNA to complex domain: Y(jω) = G + jω·C
# Gate capacitance model (Ch. 4):
#   Saturation : Cgs = 2/3·Cox·W·L + Cgso,  Cgd = Cgdo
#   Linear     : Cgs = 1/2·Cox·W·L + Cgso,  Cgd = 1/2·Cox·W·L + Cgdo
#   Cutoff     : Cgb = Cox·W·L
# ═══════════════════════════════════════════════════════════════════════════
print("\n" + "=" * 60)
print("AC Small-Signal Analysis  (Level-3: capacitance model)")
print("=" * 60)
...
fig2.suptitle(
    "CS NMOS Amplifier — Full Overview  (DC + Level-2 + AC)\n"
    f"VDD={VDD}V  RD={R_D/1e3:.0f}kΩ  Vth={VTH}V  "
...
a1.set_title("VOUT vs VIN (Level-1)"); a1.set_xlim(0, 5); a1.set_ylim(-0.1, VDD + 0.3)
...
a9.set_title("Level-2 Model Effects: VOUT vs VIN")
...
a10.set_title("Level-2 Effects: ID vs VIN")
...
plt.close()
print("Saved: results/overview.png  (5-row: DC + zooms + small-signal + Level-2 + AC)")
print("\nDone.")
